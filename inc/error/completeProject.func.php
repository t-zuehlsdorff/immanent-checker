...
/**
  ...
  *
  * Register an error for the complete project context.
  *
  ...
  *
  * The resulting error is validated by the ERROR_COMPLETE_PROJECT pool before it
  * is stored. Invalid error data is rejected instead of being stored.
  **/
function completeProject(string $strCheck,
                         string $strMessage,
